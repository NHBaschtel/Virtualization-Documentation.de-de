...
In diesem Beispiel wird das .NET Framework 4.5.2 Developer Pack installiert, indem es erst extrahiert wird und anschließend der eigentliche Installer gestartet wird. 
```none
