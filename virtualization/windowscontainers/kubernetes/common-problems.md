...
### Wie kann ich feststellen, dass Start. ps1 unter Windows erfolgreich abgeschlossen wurde? ###
...
### Kann ich so konfigurieren, dass all dies im Hintergrund statt in PoSh Windows ausgeführt wird? ###
...
### Ich habe Probleme beim Ausführen von Kubernetes-Prozessen als Windows-Dienste ###
...
Benutzer können dieses Problem identifizieren, indem Sie das [CollectLogs. ps1](https://github.com/microsoft/SDN/blob/master/Kubernetes/windows/debug/collectlogs.ps1) -Skript `*portrange.txt` ausführen und die Dateien konsultieren.
...
### Ich sehe Fehler wie "hnsCall Fehler in Win32: die falsche Diskette befindet sich auf dem Laufwerk." ###
...
### Container auf meinem Flanell-Host – GW-Bereitstellung auf Azure kann das Internet nicht erreichen ###
...
### Meine Windows-Pods können externe Ressourcen nicht anpingen ###
...
### Mein Windows-Knoten kann nicht auf einen DEPORT-Dienst zugreifen ###
...
### Im Flanell-Modus (vxlan) haben meine Pods Verbindungsprobleme, nachdem Sie dem Knoten erneut beigetreten sind. ###
...
### Nach dem Start von Start. ps1 bleibt flanelld in "warten auf das zu erstellende Netzwerk" hängen. ###
...
### Die Pod-zu-Pod-Konnektivität zwischen Hosts ist auf meinem Kubernetes-Cluster auf vSphere unterbrochen 
...
### Meine Endpunkte/IPS sind undicht ###
...
### Meine Pods können aufgrund der Fehler "Netzwerk: Fehler beim Zuweisen für Bereichsfehler" nicht gestartet werden ###
...
### Mein Windows-Knoten kann nicht mithilfe der Dienst-IP auf meine Dienste zugreifen. ###
...
### Beim Start von Kubelet wird kein Netzwerkadapter gefunden. ###
...
### Pods stoppen nach einiger Zeit die erfolgreiche Auflösung von DNS-Abfragen. ###
...
### Ich sehe immer noch Probleme. Was soll ich tun? ### 
...
>[!TIP]
> Weitere Selbsthilferessourcen finden Sie auch im Kubernetes-Problembehandlungshandbuch für Windows, das [hier zur Verfügung steht](https://techcommunity.microsoft.com/t5/Networking-Blog/Troubleshooting-Kubernetes-Networking-on-Windows-Part-1/ba-p/508648).

## Häufige Windows-Fehler ##

### Meine Kubernetes-Pods bleiben bei „ContainerCreating” hängen. ###
...
### Bei der Bereitstellung werden Docker-Container immer neu gestartet. ###
...
## Häufige Kubernetes-Master Fehler ##
...
### Verbindung mit dem API-Server unter  ist nicht möglich. `https://[address]:[port]` ###
