...
> Aufgrund der Größe des Basisimages Windows Server Core kann dieser Vorgang etwas dauern.

```none
docker run -it -p 80:80 microsoft/iis cmd
```

Nach dem Download öffnet sich der Container und eine Shellsitzung wird gestartet.
