# Nano Server-Installationsoption von Windows Server Technical Preview 5 für Entwickler
...
VHD herunterladen: [Nano Server-Installationsoption von Windows Server Technical Preview 5 für Entwickler](http://aka.ms/nanoevalvhd)

# Lizenzbedingungen

MICROSOFT-LIZENZBEDINGUNGEN FÜR EIN VHD-IMAGE DER FOLGENDEN SOFTWARE: MICROSOFT WINDOWS SERVER
...
8.  **VIDEOKOMPRIMIERUNGSSTANDARDS H.264/AVC UND MPEG-4 UND VIDEOSTANDARDS VC-1 UND MPEG-2** Diese Software kann H.264/AVC-, VC-1-, MPEG-4 Part 2- und MPEG-2-Komprimierungstechnologie enthalten. MPEG LA, L.L.C. erfordert diesen Hinweis:
