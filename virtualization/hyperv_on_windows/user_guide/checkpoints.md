...
* **Standardprüfpunkte**: Dienen zum Erstellen einer Momentaufnahme des virtuellen Computers und dessen Arbeitsspeicher zum Zeitpunkt der Prüfpunktinitiierung. Eine Momentaufnahme ist keine vollständige Sicherung und kann Probleme mit der Datenkonsistenz bei Systemen bewirken, die Daten zwischen verschiedenen Knoten replizieren, wie z. B. Active Directory. Vor Windows 10 waren mit Hyper-V nur Standardprüfpunkte (früher als Snapshots bezeichnet) verfügbar.
...
Der Standardspeicherort für das Speichern von Prüfpunktkonfigurationsdateien ist: `%systemroot%\ProgramData\Microsoft\Windows\Hyper-V\Snapshots`.
