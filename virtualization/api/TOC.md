# [Übersicht](./index.md)
# [Windows Hypervisor-Plattform-API](./hypervisor-platform/hypervisor-platform.md)
...
### [Datentypen](./hypervisor-platform/funcs/WHvPartitionPropertyDataTypes.md)
## [WHvGetVirtualProcessorRegisters](./hypervisor-platform/funcs/WHvGetVirtualProcessorRegisters.md)
### [Datentypen](./hypervisor-platform/funcs/WHvVirtualProcessorDataTypes.md)
...
### [Kontext des Beendens](./hypervisor-platform/funcs/WHvExitContextDataTypes.md)
### [Speicherzugriff](./hypervisor-platform/funcs/MemoryAccess.md)
### [E/A-Port-Zugriff](./hypervisor-platform/funcs/IOPortAccess.md)
### [MSR-Zugriff](./hypervisor-platform/funcs/MSRAccess.md)
### [CPUID-Zugriff](./hypervisor-platform/funcs/CPUIDAccess.md)
### [Ausnahmen des virtuellen Prozessors](./hypervisor-platform/funcs/VirtualProcessorException.md)
### [Unterbrechungsfenster](./hypervisor-platform/funcs/InterruptWindow.md)
### [Nicht unterstütztes Feature](./hypervisor-platform/funcs/UnsupportableFeature.md)
### [Ausführung wurde abgebrochen](./hypervisor-platform/funcs/ExecutionCancelled.md)
...
# [Hypervisor-Anweisungs-Emulator](./hypervisor-instruction-emulator/hypervisor-instruction-emulator.md)
## Anweisungsemulation
### [E/A-Port-Zugriff](./hypervisor-instruction-emulator/funcs/IOPortAccessIE.md)
### [MMIO-Zugriff](./hypervisor-instruction-emulator/funcs/MMIOAccessIE.md)
## Emulator-Strukturen
