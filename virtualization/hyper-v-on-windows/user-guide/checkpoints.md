...
* **Standardprüfpunkte**: Dienen zum Erstellen einer Momentaufnahme des Zustands des virtuellen Computers und dessen Arbeitsspeicher zum Zeitpunkt der Prüfpunktinitiierung. Eine Momentaufnahme ist keine vollständige Sicherung und kann Probleme mit der Datenkonsistenz bei Systemen verursachen, die Daten zwischen verschiedenen Knoten replizieren, wie z.B. Active Directory.  Vor Windows10 waren mit Hyper-V nur Standardprüfpunkte (früher als Snapshots bezeichnet) verfügbar.
